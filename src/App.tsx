    ...
    <footer className={`${commonClasses.container} py-6 sm:py-8 ${spacing.section} border-t border-text/10`}>
      <div className="text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6 mt-3 sm:mt-4">
          <Link to="/privacy" className="text-text/60 hover:text-text transition-colors text-xs sm:text-sm">Integritetspolicy</Link>
          <Link to="/terms" className="text-text/60 hover:text-text transition-colors text-xs sm:text-sm">Användarvillkor</Link>
          <Link to="/contact" className="text-text/60 hover:text-text transition-colors text-xs sm:text-sm">Kontakta oss</Link>
          <Link to="/feedback" className="text-text/60 hover:text-text transition-colors text-xs sm:text-sm">Feedback</Link>
        </div>
